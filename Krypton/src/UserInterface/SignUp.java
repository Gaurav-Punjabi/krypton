...
import BackEnd.Database.MySqlConnect;
 ...
 */
public class SignUp extends javax.swing.JFrame implements DocumentListener,Constants {
    ...
    private void processLogin()
    {
        ...
        if(!jtfPassword.getText().equals(jtfConfirmPassword.getText()))
        {
        ...
        try {
           ...
           close();
           jfLoading = new Loading("User");
           jfLoading.setVisible(true);
           loadingTimer = new Timer(3000,new LoadingAction());
           loadingTimer.setRepeats(false);
           loadingTimer.start();
           jfLoading.setLocation(this.getLocation().x,this.getLocation().y);
        } catch (Exception e) {
    ...
    private class LoadingAction implements ActionListener
    {
        ...
        {   
            jfMain.setLocationRelativeTo(jfLoading);
    ...
    private void initComponents() {
        ...
        jpLogin.setBackground(new java.awt.Color(86, 61, 124));
        ...
        jlSignIn.setBounds(70, 80, 90, 26);

        jtfEmail.setBackground(new java.awt.Color(86, 61, 124));
        ...
        jlPassword.setBounds(70, 240, 130, 30);

        jtfPassword.setBackground(new java.awt.Color(86, 61, 124));
        ...
        jtfPassword.setBounds(70, 280, 270, 40);
        ...
        jpLogin.add(jbLogin);
        jbLogin.setBounds(70, 470, 97, 40);

        jlPassword1.setFont(new java.awt.Font("Century Gothic", 1, 17)); // NOI18N
        jlPassword1.setForeground(new java.awt.Color(236, 240, 241));
        jlPassword1.setText("CONFIRM PASSWORD : ");
        jpLogin.add(jlPassword1);
        jlPassword1.setBounds(70, 350, 200, 30);

        jtfConfirmPassword.setBackground(new java.awt.Color(86, 61, 124));
        jtfConfirmPassword.setFont(new java.awt.Font("Century Gothic", 0, 19)); // NOI18N
        jtfConfirmPassword.setForeground(new java.awt.Color(236, 240, 241));
        jtfConfirmPassword.setText("PASSWORD");
        jtfConfirmPassword.setBorder(null);
        jtfConfirmPassword.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                jtfConfirmPasswordFocusGained(evt);
            }
            public void focusLost(java.awt.event.FocusEvent evt) {
                jtfConfirmPasswordFocusLost(evt);
            }
        });
        ...
        jpLogin.add(jtfConfirmPassword);
        jtfConfirmPassword.setBounds(70, 390, 270, 40);

        jsPassword1.setBackground(new java.awt.Color(236, 240, 241));
        jpLogin.add(jsPassword1);
        jsPassword1.setBounds(70, 430, 270, 12);
        ...
        jlTitle.setForeground(new java.awt.Color(86, 61, 124));
        jlTitle.setText("Krypton");
        jpDisplay.add(jlTitle);
        jlTitle.setBounds(107, 46, 186, 62);

        jsTitle.setBackground(new java.awt.Color(86, 61, 124));
        jpDisplay.add(jsTitle);
        jsTitle.setBounds(100, 110, 200, 20);

        jlAnimation.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserInterface/images/LoginAnimation.gif"))); // NOI18N
        jpDisplay.add(jlAnimation);
        jlAnimation.setBounds(0, 147, 400, 255);

        jlQuote.setFont(new java.awt.Font("Century Gothic", 0, 17)); // NOI18N
        jlQuote.setForeground(new java.awt.Color(86, 61, 124));
        jlQuote.setText("Be Smart.Be Secure Use Encryption");
        jpDisplay.add(jlQuote);
        jlQuote.setBounds(60, 440, 290, 22);

        jsQuote.setBackground(new java.awt.Color(86, 61, 124));
        jpDisplay.add(jsQuote);
        jsQuote.setBounds(60, 470, 280, 12);

        jsQuote2.setBackground(new java.awt.Color(86, 61, 124));
        jpDisplay.add(jsQuote2);
        jsQuote2.setBounds(100, 480, 210, 12);

        jlClose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserInterface/images/cross.png"))); // NOI18N
        ...
        jlClose.setBounds(366, 10, 24, 24);
    ...
    private void jtfConfirmPasswordFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jtfConfirmPasswordFocusGained
        // TODO add your handling code here:
    }//GEN-LAST:event_jtfConfirmPasswordFocusGained

    private void jtfConfirmPasswordFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jtfConfirmPasswordFocusLost
        // TODO add your handling code here:
    }//GEN-LAST:event_jtfConfirmPasswordFocusLost
